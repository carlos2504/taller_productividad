...
<html>
    ...
    <body>
        <div style="background-color: currentColor; font-family: cursive; color: purple; font-size: 25px">
            <center>
            
            <h1 style="font-family: cursive; color: snow; font-size: 30px">Fracciones</h1>
            
            </center>
            <p align="left" style="font-family: cursive; color: snow">
            ...
            <center>
                <h1 style="font-family: cursive; color: snow">Revisa la imagen</h1>
                <img src="cociente.png" width="588" height="284" alt="cociente"/>
            </center>
            <p align="right" style="font-family: cursive; color: snow">
            ...
            <p style="font-family: cursive; color: snow">
            ...
            <p style="font-family: cursive; color: snow" align="center">
            ...
            <p style="font-family: cursive; color: snow" align="left">
            ...
            <p style="font-family: cursive; color: snow" align="right">
            ...
            <strong>El mismo proceso se sigue con la resta de fracciones con diferente denominador solo que aquí se restan los numeradores</strong>
            ...
            <h1 style="font-family: cursive; color: snow">Te recomiendo practicar lo que has aprendido, realiza sumas, restas y multiplicaciones de fracciones.</h1><br>
            <h1 style="font-family: cursive; color: snow">Utiliza el formulario para comprobar tus sumas y restas con distinto denominador</h1><br>
            <center>
                <form style="font-family: cursive; color: dodgerblue; font-size: 35px" method="get" action="fracc">
                Númerador 1<br><br>
                <input type="text" name="txtnumerador1" size="80"><br><br>
                __________________________________________________________<br><br>
                Denominador 1<br><br>
                <input type="text" name="txtdenominador1" size="80"><br><br>
                <strong>+ -</strong><br><br>
                Númerador 2<br><br>
                <input type="text" name="txtnumerador2" size="80"><br><br>
                __________________________________________________________<br><br>
                Denominador 2<br><br>
                <input type="text" name="txtdenominador2" size="80"><br><br>
                <select name="operacionFraccion" size="1" style="font-family: cursive; font-size: 20px; color: indigo">
                ...
                <input type="submit" value="Resolver" size="100" style="color: snow; font-family: cursive; font-size: 50px; background-color: blue">
            </form>
            </center>
        </div>
    </body>
