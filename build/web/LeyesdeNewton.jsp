...
<html>
    ...
    <body>
        ...
        <h1 style="color: midnightblue; font-family: cursive; font-size: 30px;">Leyes de newton</h1>
    </center>
            <h1 style="color: dodgerblue; font-family: cursive; font-size: 20px;">Primera Ley (Ley de Inercia)</h1>
        <p style="color: orangered; font-family: cursive; font-size: 20px;" align="left">
      ...
      <p style="color: orangered; font-family: cursive; font-size: 20px;" align="center">
      ...
      <h1 style="color: orangered; font-family: cursive; font-size: 20px;">La fórmula para la primera ley de Newton es:</h1><br>
      <img src="primeraley.png" width="639" height="91" alt="primeraley"/><br>
      <h1 style="color: orangered; font-family: cursive; font-size: 20px;" align="center">Donde</h1>
        ...
        <p style="color: orangered; font-family: cursive; font-size: 20px;">
      ...
      <h1 style="color: darkgoldenrod; font-family: cursive; font-size: 20px;" align="center">Segunda Ley (Ley de Movimiento)</h1>
      <p style="color: indigo; font-family: cursive; font-size: 20px;" align="center">
        ...
        <p style="color: indigo; font-family: cursive; font-size: 20px;" align="right">
        ...
        <h1 style="color: indigo; font-family: cursive; font-size: 20px;">Las formulas que estaremos utilizando en la segunda ley son:</h1>
        <img src="f.png" width="615" height="151" alt="f"/>
        <h1 style="color: indigo; font-family: cursive; font-size: 20px;" align="center">Donde</h1><br>
        <table style="font-family: cursive; font-size: 20px; color: black" width="50%" border="1" align="center">
        ...
        <h1 style="color: indigo; font-family: cursive; font-size: 20px;" align="right">La siguiente fórmula es:</h1><br>
        <img src="a.png" width="576" height="185" alt="a" align="right"/><br>
        <h1 style="color: indigo; font-family: cursive; font-size: 20px;" align="center">Donde</h1>
        <table style="font-family: cursive; font-size: 20px; color: snow" width="50%" border="1" align="center">
        ...
        <h1 style="color: firebrick; font-family: cursive; font-size: 20px;" align="right">Tercera Ley (Ley de Acción y Reacción)</h1>
        <p style="color: darkgreen; font-family: cursive; font-size: 20px;" align="right">
        ...
        <h1 style="color: darkgreen; font-family: cursive; font-size: 20px;" align="right">La fórmula para la tercera ley es:</h1>
           <img src="terceraley.png" width="605" height="162" alt="terceraley" align="right"/><br>
           <h1 style="color: darkgreen; font-family: cursive; font-size: 20px;" align="center">Donde</h1>
            <table style="font-family: cursive; font-size: 20px; color: snow" width="50%" border="1" align="center">
           ...
           <p style="color: darkgreen; font-family: cursive; font-size: 20px;" align="center">
